...
<p align="center">
  <img src="/press-kit_0.png" alt="Blinkit Logo" width="500"/>
</p>
---
...
The ER diagram visually represents relationships between entities such as customers, orders, products, warehouses, and delivery partners.
...
- **Language:** SQL  
- **Concepts:** ER Diagram, Normalization, Constraints  
...
5. Verify data integrity using sample queries
...
- Proper use of constraints for data consistency
...
- Improved SQL and schema design skills
...
- Demonstrating real-world system modeling
